    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        ...
        .subscribe(
          ...
          err => {
            // TODO: check after .net core 3.1: how to return the errorType just like "invalid_grant" to display
            //  the concrete error by using IdentityServer 4 after updating ASP Core 3.1.
            //  because now the error of "HttpErrorResponse" is not set yet.
